								...
								<div class="row">
									...
									<div class="col col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="form-group label-floating">
											...
											<input class="form-control" type="text" name="coupon" required="required">
                                        </div>
                                        <h6 class="title">Don't have a coupon code ?<a href="{{ route('buy-coupon') }}" target="_blank"> Buy Here</a>.</h6>
                                    </div>
